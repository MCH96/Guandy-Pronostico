        ...
        Select Case e.Cell.Column.Key
            ...
            Case "Cerrar"
                ...
                Select Case CInt(e.Cell.Row.Cells("IdMes").Value)
                    Case 1
                        If PROPeriodoVendedorBO.GetAllQuery(gConnectionString, String.Format("Select Top 1 v.* From PRO_PeriodoVendedor as v inner join PRO_PeriodoVendedorDetalle as d on v.IdPeriodo=d.IdPeriodo Where v.IdPeriodo = {0} and v.Mes1 = 0", Obj.IdPeriodo)).Count > 0 Then
                            MsgBox("No se han Cerrado todos los Períodos de los Vendedores del Mes.", MsgBoxStyle.Critical, "Seguridad del sistema")
                            Exit Sub
                        End If
                    ...
                    Case 2
                        If PROPeriodoVendedorBO.GetAllQuery(gConnectionString, String.Format("Select Top 1 v.* From PRO_PeriodoVendedor as v inner join PRO_PeriodoVendedorDetalle as d on v.IdPeriodo=d.IdPeriodo Where v.IdPeriodo = {0} and v.Mes2 = 0", Obj.IdPeriodo)).Count > 0 Then
                            MsgBox("No se han Cerrado todos los Períodos de los Vendedores del Mes.", MsgBoxStyle.Critical, "Seguridad del sistema")
                            Exit Sub
                        End If
                    ...
                    Case 3
                        If PROPeriodoVendedorBO.GetAllQuery(gConnectionString, String.Format("Select Top 1 v.* From PRO_PeriodoVendedor as v inner join PRO_PeriodoVendedorDetalle as d on v.IdPeriodo=d.IdPeriodo Where v.IdPeriodo = {0} and v.Mes3 = 0", Obj.IdPeriodo)).Count > 0 Then
                            MsgBox("No se han Cerrado todos los Períodos de los Vendedores del Mes.", MsgBoxStyle.Critical, "Seguridad del sistema")
                            Exit Sub
                        End If
                    ...
                    Case 4
                        If PROPeriodoVendedorBO.GetAllQuery(gConnectionString, String.Format("Select Top 1 v.* From PRO_PeriodoVendedor as v inner join PRO_PeriodoVendedorDetalle as d on v.IdPeriodo=d.IdPeriodo Where v.IdPeriodo = {0} and v.Mes4 = 0", Obj.IdPeriodo)).Count > 0 Then
                            MsgBox("No se han Cerrado todos los Períodos de los Vendedores del Mes.", MsgBoxStyle.Critical, "Seguridad del sistema")
                            Exit Sub
                        End If
                    ...
                    Case 5
                        If PROPeriodoVendedorBO.GetAllQuery(gConnectionString, String.Format("Select Top 1 v.* From PRO_PeriodoVendedor as v inner join PRO_PeriodoVendedorDetalle as d on v.IdPeriodo=d.IdPeriodo Where v.IdPeriodo = {0} and v.Mes5 = 0", Obj.IdPeriodo)).Count > 0 Then
                            MsgBox("No se han Cerrado todos los Períodos de los Vendedores del Mes.", MsgBoxStyle.Critical, "Seguridad del sistema")
                            Exit Sub
                        End If
                    ...
                    Case 6
                        If PROPeriodoVendedorBO.GetAllQuery(gConnectionString, String.Format("Select Top 1 v.* From PRO_PeriodoVendedor as v inner join PRO_PeriodoVendedorDetalle as d on v.IdPeriodo=d.IdPeriodo Where v.IdPeriodo = {0} and v.Mes6 = 0", Obj.IdPeriodo)).Count > 0 Then
                            MsgBox("No se han Cerrado todos los Períodos de los Vendedores del Mes.", MsgBoxStyle.Critical, "Seguridad del sistema")
                            Exit Sub
                        End If
                    ...
                    Case 7
                        If PROPeriodoVendedorBO.GetAllQuery(gConnectionString, String.Format("Select Top 1 v.* From PRO_PeriodoVendedor as v inner join PRO_PeriodoVendedorDetalle as d on v.IdPeriodo=d.IdPeriodo Where v.IdPeriodo = {0} and v.Mes7 = 0", Obj.IdPeriodo)).Count > 0 Then
                            MsgBox("No se han Cerrado todos los Períodos de los Vendedores del Mes.", MsgBoxStyle.Critical, "Seguridad del sistema")
                            Exit Sub
                        End If
                    ...
                    Case 8
                        If PROPeriodoVendedorBO.GetAllQuery(gConnectionString, String.Format("Select Top 1 v.* From PRO_PeriodoVendedor as v inner join PRO_PeriodoVendedorDetalle as d on v.IdPeriodo=d.IdPeriodo Where v.IdPeriodo = {0} and v.Mes8 = 0", Obj.IdPeriodo)).Count > 0 Then
                            MsgBox("No se han Cerrado todos los Períodos de los Vendedores del Mes.", MsgBoxStyle.Critical, "Seguridad del sistema")
                            Exit Sub
                        End If
                    ...
                    Case 9
                        If PROPeriodoVendedorBO.GetAllQuery(gConnectionString, String.Format("Select Top 1 v.* From PRO_PeriodoVendedor as v inner join PRO_PeriodoVendedorDetalle as d on v.IdPeriodo=d.IdPeriodo Where v.IdPeriodo = {0} and v.Mes9 = 0", Obj.IdPeriodo)).Count > 0 Then
                            MsgBox("No se han Cerrado todos los Períodos de los Vendedores del Mes.", MsgBoxStyle.Critical, "Seguridad del sistema")
                            Exit Sub
                        End If
                    ...
                    Case 10
                        If PROPeriodoVendedorBO.GetAllQuery(gConnectionString, String.Format("Select Top 1 v.* From PRO_PeriodoVendedor as v inner join PRO_PeriodoVendedorDetalle as d on v.IdPeriodo=d.IdPeriodo Where v.IdPeriodo = {0} and v.Mes10 = 0", Obj.IdPeriodo)).Count > 0 Then
                            MsgBox("No se han Cerrado todos los Períodos de los Vendedores del Mes.", MsgBoxStyle.Critical, "Seguridad del sistema")
                            Exit Sub
                        End If
                    ...
                    Case 11
                        If PROPeriodoVendedorBO.GetAllQuery(gConnectionString, String.Format("Select Top 1 v.* From PRO_PeriodoVendedor as v inner join PRO_PeriodoVendedorDetalle as d on v.IdPeriodo=d.IdPeriodo Where v.IdPeriodo = {0} and v.Mes11 = 0", Obj.IdPeriodo)).Count > 0 Then
                            MsgBox("No se han Cerrado todos los Períodos de los Vendedores del Mes.", MsgBoxStyle.Critical, "Seguridad del sistema")
                            Exit Sub
                        End If
                    ...
                    Case 12
                        If PROPeriodoVendedorBO.GetAllQuery(gConnectionString, String.Format("Select Top 1 v.* From PRO_PeriodoVendedor as v inner join PRO_PeriodoVendedorDetalle as d on v.IdPeriodo=d.IdPeriodo Where v.IdPeriodo = {0} and v.Mes12 = 0", Obj.IdPeriodo)).Count > 0 Then
                            MsgBox("No se han Cerrado todos los Períodos de los Vendedores del Mes.", MsgBoxStyle.Critical, "Seguridad del sistema")
                            Exit Sub
                        End If
