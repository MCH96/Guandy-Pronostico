...
Public Class rptPRO_RecursosConPrecio0
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPRO_RecursosConPrecio0.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPRO_RecursosConPrecio0
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPRO_RecursosConPrecio0 = New rptPRO_RecursosConPrecio0
        rpt.Site = Me.Site
        Return rpt
    End Function
