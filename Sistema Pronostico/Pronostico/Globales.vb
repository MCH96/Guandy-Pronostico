...
Module Globales
    ...
    Public gServidorEtiqueta As String
    Public gBaseDatosEtiqueta As String
    ...
    Public gConnectionStringEtiqueta As String
    ...
    Public Function GetDataTableEtiqueta(ByVal iQuery As String, ByVal DataTableName As String) As DataTable
        Try
            Dim iAdapter As New SqlClient.SqlDataAdapter(iQuery, gConnectionStringEtiqueta)
            Dim iDataTable As DataTable = New DataTable(DataTableName)
            iAdapter.Fill(iDataTable)
            Return (iDataTable)
        Catch ex As Exception
